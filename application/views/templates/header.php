...
<head>
    ...
    <link
        href="<?php echo base_url();?>/https://fonts.googleapis.com/css2?family=DM+Sans:ital,wght@0,400;0,500;0,700;1,400;1,500;1,700&display=swap"
        rel="stylesheet">
    ...
    <link rel="stylesheet" href="<?php echo base_url();?>/assets/vendors/conult-icons/style.css">
                ...
                <div class="main-menu-wrapper clearfix">
                    <div class="main-menu-wrapper__left">
                        <div class="main-menu-wrapper__logo">
                            <a href="<?php echo site_url();?>/frontend/index"><img src="<?php echo base_url();?>/assets/images/resources/logo-1.png" alt=""></a>
                        </div>
                        <div class="main-menu-wrapper__main-menu">
                            ...
                            <ul class="main-menu__list">
                                ...
                                <li><a href="<?php echo base_url();?>frontend/Giveacall" class="nav-bar-link <?php if($this->uri->segment(2) == "login" || $this->uri->segment(2) =="registration") echo "active" ?>">Give a call</a></li>
